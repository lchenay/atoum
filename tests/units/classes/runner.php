	...
	public function test__construct()
	{
		$this
			...
			->then
				...
				->object($depedencies = $runner->getDepedencies())->isInstanceOf('mageekguy\atoum\depedencies')
			...
			->if($runner = new atoum\runner($depedencies = new atoum\depedencies()))
			->then
				->object($runner->getScore())->isInstanceOf('mageekguy\atoum\score')
				->object($runner->getAdapter())->isInstanceOf('mageekguy\atoum\adapter')
				->object($runner->getLocale())->isInstanceOf('mageekguy\atoum\locale')
				->object($runner->getIncluder())->isInstanceOf('mageekguy\atoum\includer')
				->object($runner->getTestDirectoryIterator())->isInstanceOf('mageekguy\atoum\iterators\recursives\directory')
				->object($runner->getDepedencies())->isIdenticalTo($depedencies)
				->boolean(isset($depedencies['mageekguy\atoum\runner']['adapter']))->isTrue()
				->boolean(isset($depedencies['mageekguy\atoum\runner']['locale']))->isTrue()
				->boolean(isset($depedencies['mageekguy\atoum\runner']['includer']))->isTrue()
				->boolean(isset($depedencies['mageekguy\atoum\runner']['score']))->isTrue()
			...
			->and($depedencies['mageekguy\atoum\runner']['adapter'] = $adapterInjector = function() use (& $adapter) { return $adapter = new atoum\adapter(); })
			->and($depedencies['mageekguy\atoum\runner']['locale'] = $localeInjector = function() use (& $locale) { return $locale = new atoum\locale(); })
			->and($depedencies['mageekguy\atoum\runner']['includer'] = $includerInjector = function() use (& $includer) { return $includer = new atoum\includer(); })
			->and($depedencies['mageekguy\atoum\runner']['score'] = $scoreInjector = function() use (& $score) { return $score = new atoum\score(); })
			->and($depedencies['mageekguy\atoum\runner']['directory\iterator'] = $directoryIteratorInjector = function() use (& $directoryIterator) { return $directoryIterator = new atoum\iterators\recursives\directory(); })
			->and($runner = new atoum\runner($depedencies))
			->then
				...
				->object($runner->getTestDirectoryIterator())->isIdenticalTo($directoryIterator)
				->object($runner->getDepedencies())->isIdenticalTo($depedencies)
				->object($depedencies['mageekguy\atoum\runner']['adapter'])->isIdenticalTo($adapterInjector)
				->object($depedencies['mageekguy\atoum\runner']['locale'])->isIdenticalTo($localeInjector)
				->object($depedencies['mageekguy\atoum\runner']['includer'])->isIdenticalTo($includerInjector)
				->object($depedencies['mageekguy\atoum\runner']['score'])->isIdenticalTo($scoreInjector)
				->object($depedencies['mageekguy\atoum\runner']['directory\iterator'])->isIdenticalTo($directoryIteratorInjector)
				->variable($runner->getRunningDuration())->isNull()
				->boolean($runner->codeCoverageIsEnabled())->isTrue()
				->variable($runner->getDefaultReportTitle())->isNull()
				->array($runner->getObservers())->isEmpty()
