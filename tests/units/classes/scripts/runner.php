...
class runner extends atoum\test
{
	...
	public function test__construct()
	{
		$this
			...
			->and($depedencies['mageekguy\atoum\scripts\runner']['locale'] = $locale = new atoum\locale())
			->and($depedencies['mageekguy\atoum\scripts\runner']['adapter'] = $adapter = new atoum\adapter())
			->and($depedencies['mageekguy\atoum\scripts\runner']['runner'] = $runner = new atoum\runner())
			->and($depedencies['mageekguy\atoum\scripts\runner']['includer'] = $includer = new atoum\includer())
			->and($scriptRunner = new scripts\runner($name = uniqid(), $depedencies))
			->then
				->string($scriptRunner->getName())->isEqualTo($name)
	...
	public function testUseConfigFile()
	{
		$this
			->if($depedencies = new atoum\depedencies())
			->and($depedencies['mageekguy\atoum\scripts\runner']['locale'] = $locale = new \mock\mageekguy\atoum\locale())
			->and($runner = new scripts\runner($name = uniqid(), $depedencies))
			->then
